        ...
        <div class="mt-4 px-5 pb-5">
          ...
          <div class="mt-2 mb-5 flex items-center justify-between">
            <p>
              ...
              <span class="text-sm text-slate-900 line-through">intval $car-price_per_day * 100 / 100 - $car-reduce
              </span>
            </p>
          ...
          <RouterLink :to="{ name: 'CarReservation' }" class="flex items-center justify-center rounded-md bg-slate-900 hover:bg-pr-400 px-5 py-2.5 text-center
            text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300">
            <svg id="thisicon" class="mr-4 fill-white h-6 w-6" xmlns="http://www.w3.org/2000/svg" height="1em"
              viewBox="0 0 512 512">
